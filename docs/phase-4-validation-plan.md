...
Status: **complete.** Record run `phase4-20260924-180727` on a clean Azure Windows 11 VM with outbound networking blocked; see `reports/offline-install-test.md`, `reports/offline-runtime-smoke-test.md`, `reports/checksum-verification.md` and `reports/final-gap-list.md`. The Azure procedure is `docs/phase-4-azure-runbook.md` plus `docs/phase-4-record-run.md`; the Hyper-V path (`New-Phase4Vm.ps1`) was not exercised.
